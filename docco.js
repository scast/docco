(function() {
  ...
  parse = function(source, code, config) {
    var codeText, docsText, hasCode, hasReview, i, isText, j, k, lang, len, len1, line, line1, lines, match, maybeCode, save, sections;
    if (config == null) {
      config = {};
    }
    lines = code.split('\n');
    ...
    save = function() {
      ...
      return hasCode = hasReview = docsText = codeText = '';
    };
    if (lang.literate) {
  ...
  format = function(source, sections, config) {
    var code, i, j, k, language, len, len1, line, lines, markedOptions, newText, results, section;
